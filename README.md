...
P9 додає адміністративні REST endpoint-и та React-панель керування каталогом. Старий JSP-інтерфейс
можна прибрати після приймальної перевірки production-даних і сценаріїв адміністратора.
