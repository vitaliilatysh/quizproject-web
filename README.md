...
Головна сторінка навмисно завантажує каталог повністю: її лічильник «навчальних напрямів» рахує
унікальні предмети по всьому каталогу, а це неможливо вивести з однієї сторінки — `X-Total-Count`
відповідає «скільки тестів», але не «скільки різних предметів». Щоб пагінувати й головну, потрібен
окремий ендпоінт з агрегатами каталогу.
